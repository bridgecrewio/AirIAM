...
class TestUserOrganizer(unittest.TestCase):
    def test_user_organizer(self):
        ...
        unused_users, human_users, simple_user_clusters, entities_to_detach, unchanged_users = UserOrganizer(logger, unused_threshold)\
            .get_user_clusters(iam_data)
